...
setenv APP_NAME     'wkt2geojson'
setenv APP_ROOT_DIR '/app'

setenv PATH "${PATH}:${APP_ROOT_DIR}/app_home/bin"

setenv WKT2GEOJSON_LOG_FILE "/var/log/wkt2geojson/wkt2geojson.log"
